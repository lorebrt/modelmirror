...
class MutableDefaultService:
    ...
    def __init__(self, name: str, config: Dict[str, str] = None, items: List[str] = None):
        self.name = name
...
class FastAPILikeService:
    ...
    def __init__(self, 
                 ...
                 middleware: List[Dict[str, str]] = None,
...
class ValidationSensitiveService:
    ...
    def __init__(self, name: str, port: int):
        ...
        self.validation_applied = hasattr(self.__init__, '__wrapped__')
