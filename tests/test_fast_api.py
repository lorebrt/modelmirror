...
try:
    ...
    class TestFastApi(unittest.TestCase):
        ...
        def test_fastapi_app_creation(self):
            ...
            config = self.mirror.reflect("tests/configs/fastapi_basic.json", FastAPIConfig)
        ...
        def test_fastapi_singleton_behavior(self):
            ...
            # First reflection
            config1 = self.mirror.reflect("tests/configs/fastapi_singleton.json", FastAPIConfig)
            app1 = config1.app

            # Second reflection with same singleton name
            config2 = self.mirror.reflect("tests/configs/fastapi_singleton.json", FastAPIConfig)
            app2 = config2.app
        ...
        def test_fastapi_with_middleware_inline(self):
            ...
            config = self.mirror.reflect("tests/configs/fastapi_middleware.json", FastAPIConfig)
